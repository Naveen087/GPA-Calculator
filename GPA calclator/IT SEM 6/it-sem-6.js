...
const sub1 = document.getElementById("sc");
const sub2 = document.getElementById("ns");
const sub3 = document.getElementById("cc");
const sub4 = document.getElementById("dm");
const sub5 = document.getElementById("oose");
const sub6 = document.getElementById("madl");
...
sub1.onchange = function selected1() {
  ...
  switch (true) {
    case selected1 == "O":
      gradepoint1 = 10 * credit3;
      break;

    case selected1 == "A+":
      gradepoint1 = 9 * credit3;
      break;

    case selected1 == "A":
      gradepoint1 = 8 * credit3;
      break;

    case selected1 == "B+":
      gradepoint1 = 7 * credit3;
      break;

    case selected1 == "B":
      gradepoint1 = 6 * credit3;
      break;

    case selected1 == "C":
      gradepoint1 = 5 * credit3;
      break;
...
sub5.onchange = function selected5() {
  ...
  switch (true) {
    case selected5 == "O":
      gradepoint5 = 10 * credit4;
      break;

    case selected5 == "A+":
      gradepoint5 = 9 * credit4;
      break;

    case selected5 == "A":
      gradepoint5 = 8 * credit4;
      break;

    case selected5 == "B+":
      gradepoint5 = 7 * credit4;
      break;

    case selected5 == "B":
      gradepoint5 = 6 * credit4;
      break;

    case selected5 == "C":
      gradepoint5 = 5 * credit4;
      break;
...
sub6.onchange = function selected6() {
  ...
  switch (true) {
    case selected6 == "O":
      gradepoint6 = 10 * credit15;
      break;

    case selected6 == "A+":
      gradepoint6 = 9 * credit15;
      break;

    case selected6 == "A":
      gradepoint6 = 8 * credit15;
      break;

    case selected6 == "B+":
      gradepoint6 = 7 * credit15;
      break;

    case selected6 == "B":
      gradepoint6 = 6 * credit15;
      break;

    case selected6 == "C":
      gradepoint6 = 5 * credit15;
      break;
