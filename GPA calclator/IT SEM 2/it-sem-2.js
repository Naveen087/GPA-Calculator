...
//We Have 3 Sub (with 3 credits) + 2 Sub (with 4 credits) + 3 sub (with 2credits)

//Total Credit Points for 2nd Semester

const totalCredits = 23;

const sub1 = document.getElementById("snm");
const sub2 = document.getElementById("phy2");
const sub3 = document.getElementById("beee");
const sub4 = document.getElementById("eg");
const sub5 = document.getElementById("pinc");
const sub6 = document.getElementById("eng2");
const sub7 = document.getElementById("epl");
const sub8 = document.getElementById("pincl");
