...
//We Have 4 Sub (with 3 credits) + 1 Sub (with 4 credits) + 2 sub (with 2credits)

//Total Credit Points for 1st Semester

const totalCredits = 20;

const sub1 = document.getElementById("mac");
const sub2 = document.getElementById("phy1");
const sub3 = document.getElementById("chm");
const sub4 = document.getElementById("pspp");
const sub5 = document.getElementById("eng1");
const sub6 = document.getElementById("psppl");
const sub7 = document.getElementById("pcl");
